...
train = pd.read_csv("/storage/home/jkl5991/work/project/not_conflict/cv/0730/validation/train_recess.tsv", sep = "\t")
valid = pd.read_csv("/storage/home/jkl5991/work/project/not_conflict/cv/0730/validation/valid_recess.tsv", sep = "\t")
...
with open("result_recess/%s%s%s.txt"%(sys.argv[1],sys.argv[2],sys.argv[3]),"w") as f:
